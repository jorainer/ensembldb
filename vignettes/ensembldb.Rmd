...
output:
  BiocStyle::html_document:
    toc_float: true
    includes:
      in_header: ensembldb.bioschemas.html
vignette: >
...
fetched from Ensembl <sup><a id="fnr.1" class="footref" href="#fn.1">1</a></sup>
...
- `TxNameFilter`: filter on the Ensembl transcript names (if available). These
  represent the *external name* of the transcripts as provided by Ensembl. The
  data is filtered on the transcript IDs if no transcript names are available in
  the database.
...
genes<sup><a id="fnr.2" class="footref" href="#fn.2">2</a></sup> are defined in
...
the `summarizeOverlaps` function from the `GenomicAlignments` package <sup><a
id="fnr.3" class="footref" href="#fn.3">3</a></sup>.
