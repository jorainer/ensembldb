...
(see Section [11](#orgefb6b14) for the database layout and an overview of
...
# Database layout<a id="orgefb6b14"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [156](#orgb6686b6)). Note that the protein-specific annotations
