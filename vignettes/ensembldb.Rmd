...
(see Section [11](#org71054dd) for the database layout and an overview of
...
# Database layout<a id="org71054dd"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [137](#org1010ec3)). Note that the protein-specific annotations
