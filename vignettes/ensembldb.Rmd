...
(see Section [11](#orgf7ebffb) for the database layout and an overview of
...
# Database layout<a id="orgf7ebffb"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [165](#org1c8c706)). Note that the protein-specific annotations
