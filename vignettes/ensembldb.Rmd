...
<li><a href="#orgheadline2">2. Using <code>ensembldb</code> annotation packages to retrieve specific annotations</a></li>
<li><a href="#orgheadline3">3. Extracting gene/transcript/exon models for RNASeq feature counting</a></li>
<li><a href="#orgheadline4">4. Retrieving sequences for gene/transcript/exon models</a></li>
<li><a href="#orgheadline5">5. Interactive annotation lookup using the <code>shiny</code> web app</a></li>
<li><a href="#orgheadline6">6. Important notes</a></li>
<li><a href="#orgheadline9">7. Building an transcript centric database package based on Ensembl annotation</a>
<ul>
<li><a href="#orgheadline7">7.1. Requirements</a></li>
<li><a href="#orgheadline8">7.2. Building an annotation package</a></li>
</ul>
</li>
<li><a href="#orgheadline10">8. Database layout</a></li>
</ul>
</div>
</div>
...
[8](#orgtarget1) for the database layout and an overview of available
attributes/columns).
...
# Using `ensembldb` annotation packages to retrieve specific annotations<a id="orgheadline2"></a>
...
e.g. `condition`"`"` to retrieve all entries matching the filter value,
`condition`"!="= to negate the filter or also `condition`"like"= to allow
...
```{r }
yCds <- cdsBy(EnsDb.Hsapiens.v75, filter=SeqnameFilter("Y"))
yCds
```
...
# Extracting gene/transcript/exon models for RNASeq feature counting<a id="orgheadline3"></a>
...
# Retrieving sequences for gene/transcript/exon models<a id="orgheadline4"></a>
...
between the chromosomal start and end coordinates of the gene.  To retrieve the
(exonic) sequence of transcripts (i.e. without introns) we first fetch all exons
grouped by transcripts and then extract and paste the sequence of all of the
transcripts' exons.
...
# Interactive annotation lookup using the `shiny` web app<a id="orgheadline5"></a>
...
# Important notes<a id="orgheadline6"></a>
...
# Building an transcript centric database package based on Ensembl annotation<a id="orgheadline9"></a>
...
## Requirements<a id="orgheadline7"></a>
...
## Building an annotation package<a id="orgheadline8"></a>
...
`host = "mysql-eg-publicsql.ebi.ac.uk"`, `port=4157` and species to
e.g. `species = "arabidopsis thaliana"`.
...
# Database layout<a id="orgtarget1"></a><a id="orgheadline10"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [84](#orgparagraph1)):
