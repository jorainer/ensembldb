...
```{r tx-for-zbtb16, message=FALSE, fig.align='center', fig.width=7.5, fig.height=5, echo=TRUE, results='hide'}
...
```{r gviz-plot, message=FALSE, fig.align='center', fig.width=7.5, fig.height=2.25, echo=TRUE, results='hide'}
...
```{r gviz-separate-tracks, message=FALSE, warning=FALSE, fig.align='center', fig.width=7.5, fig.height=2.25, echo=TRUE, results='hide'}
