...
(see Section [11](#orgbbd4ad6) for the database layout and an overview of
...
# Database layout<a id="orgbbd4ad6"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [159](#org4ac386c)). Note that the protein-specific annotations
