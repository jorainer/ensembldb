...
(see Section [11](#org520407a) for the database layout and an overview of
...
# Database layout<a id="org520407a"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [164](#org1bef1c7)). Note that the protein-specific annotations
