...
(see Section [11](#orgea73779) for the database layout and an overview of
...
# Database layout<a id="orgea73779"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [164](#org6f7d460)). Note that the protein-specific annotations
