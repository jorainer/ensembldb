...
(see Section [10](#orge2c6fe0) for the database layout and an overview of
...
# Database layout<a id="orge2c6fe0"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [144](#org2a11754)). Note that the protein-specific annotations
