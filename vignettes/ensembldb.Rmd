...
(see Section [11](#org9c3495f) for the database layout and an overview of
...
# Database layout<a id="org9c3495f"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [156](#org92f0a36)). Note that the protein-specific annotations
