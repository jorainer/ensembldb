...
(see Section [11](#orgd08c9a9) for the database layout and an overview of
...
# Database layout<a id="orgd08c9a9"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [162](#org9f25eef)). Note that the protein-specific annotations
