...
(see Section [11](#org139b93a) for the database layout and an overview of
...
# Database layout<a id="org139b93a"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [165](#org5531bf3)). Note that the protein-specific annotations
