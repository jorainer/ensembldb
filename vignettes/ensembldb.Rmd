...
(see Section [11](#org0ae2da6) for the database layout and an overview of
...
# Database layout<a id="org0ae2da6"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [165](#orgf275dcb)). Note that the protein-specific annotations
