...
(see Section [11](#orgceefdbb) for the database layout and an overview of
...
# Database layout<a id="orgceefdbb"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [135](#orgeacf282)). Note that the protein-specific annotations
