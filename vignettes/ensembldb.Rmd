...
(see Section [10](#org905b017) for the database layout and an overview of
...
# Database layout<a id="org905b017"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [149](#org586837f)). Note that the protein-specific annotations
