...
(see Section [11](#orgd0a7259) for the database layout and an overview of
...
# Database layout<a id="orgd0a7259"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [156](#orga2ff17d)). Note that the protein-specific annotations
