...
(see Section [11](#org43dc748) for the database layout and an overview of
...
# Database layout<a id="org43dc748"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [156](#orgc122505)). Note that the protein-specific annotations
