...
(see Section [11](#orgec77bc9) for the database layout and an overview of
...
# Database layout<a id="orgec77bc9"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [134](#org536e445)). Note that the protein-specific annotations
