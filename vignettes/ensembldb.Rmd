...
(see Section [11](#org458c42a) for the database layout and an overview of
...
# Database layout<a id="org458c42a"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [165](#orgdc848d1)). Note that the protein-specific annotations
