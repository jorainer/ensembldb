...
(see Section [11](#org0dc6e2b) for the database layout and an overview of
...
```{r  granges-zbtb16, message = FALSE, fig.align = 'center', echo = FALSE }
...
```{r  gviz-plot, gviz-plot, message=FALSE, fig.align = 'center', fig.width=7.5, fig.height=2.3 }
...
# Database layout<a id="org0dc6e2b"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [164](#org9d6c074)). Note that the protein-specific annotations
