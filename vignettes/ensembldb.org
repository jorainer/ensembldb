...
** CANCELED Integration with =Organism.dplyr=
   ...
   - State "CANCELED"   from "TODO"       [2017-02-10 Fri 15:22] \\
     No need to perform this - we have now a dedicated =AnnotationFilters= package for
     this.
...
** TODO Use =filters= as they are used in =Organism.dplyr=
...
** TODO Interpret R logical conditions
